...
<template>
  <div class="min-h-screen bg-gradient-stage relative overflow-hidden">
    <!-- Ambient glow -->
    <div class="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-coral/10 rounded-full blur-[120px] pointer-events-none"></div>
    ...
    <div class="relative z-10 min-h-screen flex flex-col items-center justify-center p-6">
      ...
      <div class="mb-12 text-center animate-fade-up">
        <h1 class="font-display text-5xl md:text-6xl font-bold text-gradient mb-3">
          NextUp
        </h1>
      ...
      <div class="w-full max-w-md animate-fade-up delay-150">
        ...
        <template v-else>
          <div class="card bg-surface-elevated/80 backdrop-blur-xl border border-white/5 shadow-2xl animate-scale-in">
